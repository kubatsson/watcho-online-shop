    ...
    public partial class Initialandseed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 3, 31, 13, 40, 38, 142, DateTimeKind.Utc).AddTicks(3737), "Male", new DateTime(2021, 3, 31, 13, 40, 38, 142, DateTimeKind.Utc).AddTicks(3737) });

            migrationBuilder.InsertData(
                table: "Genders",
                columns: new[] { "Id", "CreatedAt", "GenderName", "ModifedAt" },
                values: new object[] { 2, new DateTime(2021, 3, 31, 13, 40, 38, 142, DateTimeKind.Utc).AddTicks(5023), "Female", new DateTime(2021, 3, 31, 13, 40, 38, 142, DateTimeKind.Utc).AddTicks(5023) });
